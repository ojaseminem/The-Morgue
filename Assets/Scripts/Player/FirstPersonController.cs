...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(cameraCanMove && playerCanMove)
        {
        ...
        if(playerCanMove && enableJump && Input.GetKeyDown(jumpKey) && isGrounded)
        {
            Jump();
        }
    ...
    public static void ToggleAudioListener(bool turnOn) => Instance.playerCamera.GetComponent<AudioListener>().enabled = turnOn;
